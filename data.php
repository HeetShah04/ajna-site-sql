  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        ...
        <form class="form-inline my-2 my-lg-0" action="search/search.php">
...
<?php
      ...
      <?php 
      echo "<td><a class='btn btn-info'href='update.php?id=$result1[id]&fn=$result1[first_name]&ln=$result1[last_name]&mn=$result1[mobile_no]&en=$result1[email]&ad=$result1[address]'>Edit</a>
